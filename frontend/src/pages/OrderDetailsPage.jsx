...
const OrderDetailsPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchOrderDetails = async () => {
      try {
        ...
        if (!response.ok) {
          throw new Error(data.message || 'Có lỗi xảy ra khi tải đơn hàng');
        }
  ...
  if (error) return (
    <div className="text-center py-12">
      ...
      <Link to="/my-orders" className="text-pink-500 hover:text-pink-600 font-medium">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p>Điện thoại: {order.shippingAddress?.phone || 'Không có số điện thoại'}</p>
            </div>
          </div>
