  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-pink-500 to-pink-600 text-white p-6 rounded-lg shadow-lg">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-pink-100">Trang làm việc dành cho nhân viên giao hàng</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-pink-600 text-sm font-medium">Đơn cần giao</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-pink-600 text-sm font-medium">Đang giao</p>
              <p className="text-2xl font-bold text-gray-900">0</p>
            </div>
            <FaRoute className="text-pink-500 text-2xl" />
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-pink-600 text-sm font-medium">Hoàn thành hôm nay</p>
              <p className="text-2xl font-bold text-gray-900">0</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-pink-600 text-sm font-medium">Khoảng cách</p>
      ...
      <div className="bg-pink-50 border border-pink-200 p-6 rounded-lg">
        <h3 className="text-lg font-semibold text-pink-800 mb-2">Hướng dẫn cho nhân viên giao hàng</h3>
