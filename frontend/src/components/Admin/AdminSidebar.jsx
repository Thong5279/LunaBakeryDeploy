...
import { FaBox, FaBoxOpen, FaClipboard, FaClipboardList, FaSignOutAlt, FaStore, FaUser } from "react-icons/fa";
...
const AdminSidebar = () => {
  ...
  return (
    <div className="p-6">
      ...
      <div className="mt-4">
        <button onClick={handleLogout} className="w-full bg-pink-400 hover:bg-pink-500 py-2 rounded-3xl flex items-center justify-center space-x-2">
            <FaSignOutAlt/>
