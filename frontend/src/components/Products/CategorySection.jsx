  ...
  return (
    <section className="py-16 px-4 lg:px-0">
      <div className="container mx-auto flex flex-col md:flex-row gap-8">
        ...
        <Link to="/collections/all?cake" className="relative flex-1 group cursor-pointer overflow-hidden rounded-xl shadow-md">
          <img
          ...
          <div className="absolute bottom-8 left-8 bg-white bg-opacity-90 p-4 rounded-lg">
            ...
            <p className="text-sm text-gray-600">Khám phá những chiếc bánh tuyệt vời</p>
          </div>
        </Link>

        {/* Baking Category */}
        <Link to="/collections/all?ingredient" className="relative flex-1 group cursor-pointer overflow-hidden rounded-xl shadow-md">
          <img
          ...
          <div className="absolute bottom-8 left-8 bg-white bg-opacity-90 p-4 rounded-lg">
            ...
            <p className="text-sm text-gray-600">Nguyên liệu chất lượng cho chiếc bánh hoàn hảo</p>
          </div>
        </Link>
